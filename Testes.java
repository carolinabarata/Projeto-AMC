...
public class Testes {
    ...
    public static void main(String[] args) throws Exception {
        Gauss gauss1 = new Gauss(0.5, 1, 10.02594478941936, -10.02594478941936 , 0.1421076870773704,0.4643269806024326);
        Gauss gauss2 = new Gauss(0.5,1,  12.20597251194456, -12.20597251194456, 0.2974943986762133,1.8424072051479376);
       // Gauss gauss3 = new Gauss(0.25, 1.3, 33.42180010720883, -33.42180010720883, 0.3322288883170215,0.49111355583020927);
        ...
        Mix novamix = new Mix(2,listagauss);
