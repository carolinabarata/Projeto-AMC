...
public class AmostraOld {
    ...
    public String toString() {
        return "AmostraOld[first=" + first + ", length=" + length + "]";
    }
     ...
     * Estamos a assumir que podem então existir na AmostraOldvários índices iguais.
     */
    ...
    /**
     * Este método recebe uma AmostraOlde cria uma nova AmostraOldque é a concatenação destas,
     * sem alterar as duas Amostras iniciais.
     */
    public AmostraOld join(AmostraOld other) {
        AmostraOld c = new AmostraOld();
     ...
     */
    private void copyAndAppend(AmostraOld source, AmostraOld destination) {
